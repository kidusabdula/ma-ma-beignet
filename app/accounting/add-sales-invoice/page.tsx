    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <h1 className="text-2xl font-semibold text-[var(--card-foreground)]">
          New Sales Invoice <span className="text-red-600 text-sm font-bold">Not Saved</span>
        </h1>
      ...
      <div className="bg-[var(--card)] p-4 rounded-lg border border-[var(--border)]">
          ...
          <div>
            ...
            <Select>
              <SelectTrigger className="w-full bg-[var(--input)] text-[var(--card-foreground)] border-[var(--border)]">
                <SelectValue placeholder="ACC-SINV-YYYY-..." />
              </SelectTrigger>
              <SelectContent>
                <SelectItem value="acc-sinv-yyyy">ACC-SINV-YYYY-...</SelectItem>
              </SelectContent>
            </Select>
          </div>
          <div>
        ...
        <div className="mt-4 flex flex-col space-y-2">
          ...
          <div className="flex space-x-4">
            <Checkbox id="include-payment-pos" />
            <label
              htmlFor="include-payment-pos"
              className="text-[var(--card-foreground)] text-sm"
            >
              Include Payment (POS)
            </label>
            <Checkbox id="return-credit-note" />
            <label
              htmlFor="return-credit-note"
              className="text-[var(--card-foreground)] text-sm"
            >
              Return (Credit Note)
            </label>
            <Checkbox id="rate-adjustment" />
            <label
              htmlFor="rate-adjustment"
              className="text-[var(--card-foreground)] text-sm"
            >
              Issue a debit note with qty adjustment against an existing Sales
              Invoice
            </label>
          </div>
        </div>
      ...
      <div className="bg-[var(--card)] p-4 rounded-lg border border-[var(--border)]">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
          ...
          <div>
            ...
            <Input
              placeholder="Sales Taxes and Charges Template"
              className="bg-[var(--input)] text-[var(--card-foreground)] border-[var(--border)]"
            />
          </div>
        </div>
